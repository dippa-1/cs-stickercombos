		<a href="https://github.com/dippa-1/cs-stickercombos" target="_blank" class="group">
			<svg
				class="h-8 w-8 text-gray-800 dark:text-white transition-transform duration-300 group-hover:scale-125"
				aria-hidden="true"
